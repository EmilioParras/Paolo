...
<h1 style=" display:flex; justify-content: center; margin-top: 10px;">Temporada {foreach from=$datosTemporada item=$numeroTemporada}{$numeroTemporada->numeroTemporada} Primera.{/foreach}</h1>
