                ...
                {foreach from=$equipos item=$equipo}
                    <tr {if $counter == 1} style="background-color: #90EE90;"{/if}>
                        <td {if $counter == 1} style="background-color: #008000;"
                            ...
                            {else if $counter == 3} style="background-color: #D68526;"
                            {else if $counter == 9} style="background-color: #a4332b;" 
                            {else if $counter == 10} style="background-color: #a4332b;"
                            {else if $counter % 3 == 0} style="background-color: #E5E5E5;"
                            {/if}>
                            {counter}
                        </td>
