    ...
    <div class="contenedorTablaPrincipalYEquipos">
        ...
        <div class="tablaPrincipal">
            <table>
                ...
                <tr style="background-color: #1F2029; color: #FFEBA7;">
                    <th>#</th>
                    <th>Equipo</th>
                    <th>Pts</th>
                    <th>PJ </th>
                ...
                {foreach from=$equipos item=$equipo}
                    <tr {if $counter == 1} style="background-color: #90EE90;"{/if}>
                        <td {if $counter == 1} style="background-color: #008000;"
                                {else if $counter == 2} style="background-color: #008000;"
                                {else if $counter == 3} style="background-color: #008000;"
                                {else if $counter == 4} style="background-color: #008000;"
                                {else if $counter == 5} style="background-color: #E8D747;"
                                {else if $counter == 6} style="background-color: #E8D747;"
                                {else if $counter == 7} style="background-color: #E8D747;"
                                {else if $counter == 8} style="background-color: #E8D747;"
                            {/if}>
                            {counter}
                        </td>
